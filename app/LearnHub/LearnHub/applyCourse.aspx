...
<div class="container">
        ...
        <form class="form-horizontal" runat="server">
            <fieldset>
                <legend>Training Nomination Form</legend>

                <h4>Section A - Personal Particulars</h4>
                <div class="form-group">
                    <strong>
                        <asp:Label ID="nameOfStaffLabel" runat="server" CssClass="col-lg-2 control-label" Text="Name Of Staff"></asp:Label></strong>
                    <div class="col-lg-10">
                        <asp:TextBox ID="nameOfStaffInput" runat="server" CssClass="form-control" placeholder="Name Of Staff"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <asp:TextBox ID="employeeNoInput" runat="server" CssClass="form-control" placeholder="Employee Number"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
