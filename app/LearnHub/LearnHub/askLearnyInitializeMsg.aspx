<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage.Master" AutoEventWireup="true" CodeBehind="askLearnyInitializeMsg.aspx.cs" Inherits="LearnHub.askLearnyInitializeMsg" %>
        ...
        <div class="container">
            ...
            <asp:GridView ID="gvMessages" runat="server" AutoGenerateColumns="False" DataKeyNames="messageID" DataSourceID="SqlDataSourceMessages" GridLines="None" CssClass="table table-striped table-hover">
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <a href="askLearnyEditInitializeMsg.aspx?id=<%# Eval("messageID") %>" class="btn btn-info btn-sm pull-right"><span class="glyphicon glyphicon-pencil"></span></a>
                        </ItemTemplate>
                    </asp:TemplateField>
