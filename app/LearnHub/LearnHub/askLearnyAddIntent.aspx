<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage.Master" AutoEventWireup="true" CodeBehind="askLearnyAddIntent.aspx.cs" Inherits="LearnHub.askLearnyAddIntent" %>
                ...
                <tbody>
                    <%
                        ...
                        foreach (ChatBotIntent cbi in allChatBotIntents)
                        {
                            ...
                            Response.Write($"<td><a href=\"askLearnyEditIntent.aspx?id={cbi.intentID}\" class=\"btn btn-info btn-sm pull-right\"><span class=\"glyphicon glyphicon-pencil\"></span></a></td>");
                            Response.Write("</tr>");
                        }
                    %>
                </tbody>
