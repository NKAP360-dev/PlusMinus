            ...
            <fieldset>
                ...
                <div class="form-group required">
                    ...
                    <div class="col-lg-5">
                        ...
                        <asp:RequiredFieldValidator ID="rfv_lblDept" runat="server" ErrorMessage="Please Select a Department" ControlToValidate="lblDept" InitialValue="none" ForeColor="Red" ValidationGroup="ValidateForm" Display="Dynamic"></asp:RequiredFieldValidator>
                        </div>
                </div>
                <div class="form-group required">
                    <strong>
