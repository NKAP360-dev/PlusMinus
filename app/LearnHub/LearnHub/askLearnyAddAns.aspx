<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage.Master" AutoEventWireup="true" CodeBehind="askLearnyAddAns.aspx.cs" Inherits="LearnHub.askLearnyAddAns" %>
                ...
                <tbody>
                    <% 
                        ...
                        foreach (ChatBotAnswer cba in allAnswers)
                        {
                            ...
                            Response.Write($"<a href=\"askLearnyEditAns.aspx?id={cba.answerID}\" class=\"btn btn-info btn-sm pull-right\"><span class=\"glyphicon glyphicon-pencil\"></span></a>");
                            Response.Write("</td>");
                            Response.Write("</tr>");
                        }%>
                </tbody>
