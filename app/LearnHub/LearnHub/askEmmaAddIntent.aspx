...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form class="form-horizontal" runat="server">
        <div class="container">
            ...
            <br />
            <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for Intents">

            <table class="table table-striped table-hover with-pager" id="myTable">
                <thead>
                    <tr>
                        <th onclick="sortTable(0)" width="90%">Intent&emsp;<span class="glyphicon glyphicon-sort"></span></th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
