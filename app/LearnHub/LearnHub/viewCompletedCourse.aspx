<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage.Master" AutoEventWireup="true" CodeBehind="viewCompletedCourse.aspx.cs" Inherits="LearnHub.viewCompletedCourse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <ul class="breadcrumb">
        ...
        <li class="active">My Completed Courses</li>
    </ul>
